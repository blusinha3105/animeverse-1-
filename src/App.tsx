...
import AdminUsersPage from './components/admin/pages/AdminUsersPage'; // New Admin Users Page
...
const UserPrivateRoute: React.FC<PrivateRouteProps> = ({ children }) => {
  ...
  if (user && user.is_banned) {
    // Redirect to login, LoginPage will show ban reason if passed in state
  ...
  <AdminPrivateRoute>
    <AdminLayout>
      <Routes>
        ...
        <Route path="users" element={<AdminUsersPage />} /> {/* New Admin Users Route */}
