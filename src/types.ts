...
export interface User {
  ...
  is_banned?: boolean; // New: for ban status
  banned_reason?: string | null; // New: reason for ban
  admin_promotion_key_used?: string | null; // New: tracks if promotion key was used (optional detail)
}
...
export interface AuthResponse {
  ...
  reason?: string; // Optional: for login error messages, e.g., ban reason
}
